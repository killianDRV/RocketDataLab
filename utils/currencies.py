currencies = [
    ...
    "SZL (Eswatini Lilangeni)", "THB (Thai Baht)", "TJS (Tajikistani Somoni)", "TMT (Turkmenistan Manat)", 
    "TND (Tunisian Dinar)", "TRY (Turkish Lira)", "TTD (Trinidad and Tobago Dollar)", "TVD (Tuvaluan Dollar)", 
